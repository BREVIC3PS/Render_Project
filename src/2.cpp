...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("shader/8.light.vs", "shader/8.light.fs");;
    ...
    unsigned int GlowMap = loadTexture(std::string("resources/textures/matrix.jpg").c_str());
    // render loop
    // -----------
    while (!glfwWindowShouldClose(window))
    {
        ...
        // material properties
        lightingShader.setInt("material.diffuse", 0); //绑定第0个texture
        lightingShader.setInt("material.specular", 1); //绑定第1个texture
        lightingShader.setInt("glow", 2); //绑定第1个texture
